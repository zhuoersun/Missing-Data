# 1. For full data analysis: beta_full;
# 2. Use full data as a benchmark in the simulations;
...
full_MAR <- function(xd,inno,alpha,n,seed){
  Beta=matrix(0,MC,5)
