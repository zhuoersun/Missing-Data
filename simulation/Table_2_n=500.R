...
Beta0 <- full_MAR(xd="n",inno="n",alpha=alpha,n=500,seed=1234)
bias0 <- Beta0$bias
epsd0 <- Beta0$epsd
...
####CC under MAR####
Beta1 <- CC_MAR(xd="n",inno="n",alpha=alpha,n=500,seed=1234)
bias1 <- Beta1$bias
epsd1 <- Beta1$epsd
...
####IPW under MAR####
Beta2 <- ip_noaug_MAR(xd="n",inno="n",alpha=alpha,n=500,seed=1234,trim=1e-4)
bias2 <- Beta2$bias
epsd2 <- Beta2$epsd
...
####PIPA under MAR####
Beta3 <- ip_aug_MAR(xd="n",inno="n",alpha=alpha,n=500,seed=1234,trim=1e-4)
bias3 <- Beta3$bias
epsd3 <- Beta3$epsd
cover3 <- Beta3$cover
...
####AWEE under MAR####
Beta5 <- AWEE_MAR(xd="n",inno="n",alpha=alpha,n=500,seed=1234,trim=1e-4)
bias5 <- Beta5$bias
epsd5 <- Beta5$epsd
...
save.image(file="MC_normal_n=500_3.RData")
